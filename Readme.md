...
3. THE TROUBLESHOOTING SCENARIO (Real-Life Production Incident): Create a detailed, realistic production outage scenario. Explain the exact business impact and what the metrics look like during the crash.
...
1. THE REAL-LIFE TRANSLATION: Look at the current numbers in my output. Explain what is happening inside my server right now using a simple, real-life analogy.
...
3. THE HIDDEN RISK TRAP: Based on my current data, is there a hidden bottleneck creeping up? Explain the risk in simple business terms.
